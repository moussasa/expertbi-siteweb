...
style="padding: 10px;border-radius: 10px;margin: 10px">      <div class="container">
    ...
    <div class="content-section">
        ...
        <p>
            ...
            objectif était de mettre ses compétences au service des entreprises. Située à Bamako, Mali, cette entreprise a
            évolué avec le temps.
        </p>
        <p>
            Par la suite, le promoteur s’est inscrit à un second master en système d’information économique et financière,
            qu’il a terminé en 2021. Avec des ambitions grandissantes vers l’analyse de données, il a commencé à exécuter
            des missions de data analyste en freelance en France. En janvier 2024, Paul-Service est devenu Expert BI SARL,
    ...
    <div class="content-section">
        ...
        <p>
            ...
            permanente. Nos consultants, incluant des ingénieurs en développement, en sécurité de l’information et en réseau
        ...
        <p>
            L’équipe permanente comprend un chargé commercial, un comptable data analyste, et plusieurs autres compétences
